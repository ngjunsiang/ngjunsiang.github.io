...
Opening Remarks: Dr Ng Aik Beng, NVIDIA AI Technology Centre
- Recent developments in NVIDIA
- Capabilities: edit videos, look for anomalous behaviour in recordings, parse forum content

Keynote 3: Dr Miao Chun Yan (NTU)
Agentic AI in Learning
- teachable AI (learning by teaching)
- curious AI (theory of human learning, Berlyne)
- persuasive AI (elaboration likelihood model)
- remembrance AI (remote links, spaced repetition)

CLC case study: virtual Singapura
<summary of findings>
Teachable agent has a goal: "to learn"

Keynote 4: Dr Mutlu Cukurova (UCL)
Teacher-AI Teaming in Education
3 conceptualisations
- Human task replaced by AI
- Human internalises AI model (adapt to AI)
- Human (capabilities) extended with AI

GenAI-assisted lesson & resource preparation resulted in 31% reduction in time (81.5 min -> 56.2 min)
Issues
- Replacement - accuracy, reliability
  LLMs don't produce same benefits as ITS (intelligent tutoring systems)
- Cognitive Atrophy
- Praxical Teaming: AI assistant learns from teacher about how to give feedback, by generating feedback first and getting corrected. But perhaps iverly optimistic, lacks existing task synergy.

Panel discussion
Asst Prof Tanmay Sinha (NTU/NIE)
Dr Yang Yang (NTU/NIE)
Dr Aishah Abdul Rahman (NTU/NIE)
Dr Lee Vwen Yen Alwyn (NTU/NIE)

All learning is emotional

Children's socio-emotional development, academic achievement, teacher-student relationship are related to early reading/writing skills (4-7 yo)
Emotion socialisation in parent-child conversation
- reference to internal states
- reference to behaviours
- can also be taught through teacher-child conversation

Executive function
- working memory
- inhibition -- suppress distractors
- shifting -- flexibility in changing tactics/strategy

children performed better in tasks when momentarily frustrated (Yorkes-Dodson Law)
optimal performance achieved when appropriately aroused

Can we use data analytics to detect unproductive frustration?

Epistemic Emotions
- achievement emotions, e.g. feelings towards academic results
- topic emotions, e.g. feelings towards academic subject
- ??? emotions, e.g. feelings towards uncooperative teammate

Emosense: a research project building a system to elevate epistemic emotions to teachers and students
- 65% prediction accuracy about student enjoyment
- 33% prediction accuracy about student boredom/confusion

Generally, boredom, anxiety, and frustration kick in when starting work on assigments/assessments
but when complete, curiosity and interest in topic remain!

Parallel Talk T2c

Productive struggle for optimal learning
- intrinsic motivation
  - autonomy
  - competence
  - relatedness
- Teacher-Learner trust
- Uncertainty tolerance
  - Behavioural: act wisely, crave novelty
  - Cognitive: inherent to learning
  - Affective: manage discomfort

Parallel Talk T2d
AI Education in Dutch - Dr Sharon Calor
- teaching computational thinking to be applied in different subjects

Research question: which learning objective, assessment method, teaching method, and technology contribute to students learning to use computational thinking?

Product: small-group scaffolding tool (for math)

(1) determine whether group has reached max level of understanding - yes -> (6) or - no -> (2) diagnose group's max level of understanding -> (3) Check diagnosis -> (2) or (4) Provide support -> (5) Check if group can continue -> (4) or (6) provide process support

Dr Ricky Chua - decoupling student's gen-AI work from assessment criteria
SAMR framework (Dr Ruben Puentedura)
- Redefine
- Modify
- Augment
- Substitute
...
Performative assessment: present project, but with constraints
- slide can only have 5 words
- script goes into slide notes not on screen
- no script allowed during presentation
- allowances
  - use image as trigger
  - no limit to number of slides
(suffered 3% drop in teaching evaluation)
unintended outcomes
- students found it easier
- students demonstrated more creativity
- students felt they had more control over presentation

Assoc Prof Lisa Winstanley - AI in design & art education

Ethics: Models train on data unethically

Art & Design Educators
- teach transparency & source acknowledgement
- assess process, not just outcomes
- allow ethical refusal: don't have to use AI
- encourage slow design, iteration, failure

Panel discussion
- Ricky: students often do not want to be in the module/lesson (if it's a mandatory module)
  - resort to AI so they don't have to engage/think; AI cannot engage students without the educator
- Lisa: use AI to articulate/overcome a temporary handicap: empower rather than limit -- AI as provocateur?
- Carol: scaffold: in 2nd year, students get to use AI, but must firt be able to do the task without AI. Then when use AI, have them tackle higher-order thinking tasks

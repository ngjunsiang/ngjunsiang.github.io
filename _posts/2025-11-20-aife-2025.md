...
Drawing on feedback literature, Dr. Mohamed emphasized principles for effective feedback that reflect ideas similar to contemporary work on reconceptualizing feedback practice (Boud & Molloy, 2013): feedback should be **contextual** (referencing class content), **relational** (operating in a shared teacher-learner space), and **personal** (conveying authentic voice). The system addresses a specific problem: the emergence of copy-paste ChatGPT feedback that students recognize as inauthentic and generic. By maintaining the instructor's voice and requiring human review, the system aims to preserve the relational dimension of feedback while scaling the instructor's capacity.
...
Prof. Cukurova presented a framework describing different ways AI can be conceptualized in educational contexts, which he applied to teacher-AI interaction (Cukurova, 2024):
